"""
Temperature scaling calibration for improved ECE.
...
def find_temperature(logits, labels, t_range=(0.1, 10.0)):
    """
    Find the optimal temperature T that minimizes NLL on validation set.
    """
    def nll_at_temp(T):
        scaled = logits / T
...
def main():
    ...
    parser.add_argument("--output", default="checkpoints/temperature.json",
                        help="Where to save the temperature value")
    ...
    val_loader = DataLoader(val_dataset, batch_size=v_conf['batch_size'],
